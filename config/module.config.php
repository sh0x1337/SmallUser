...
return [
    ...
    'service_manager' => [
        'aliases' => [
            ...
            'small_user_info' => Service\UserInfo::class,
            'small_user_company' => Service\UserCompany::class,
        ...
        'factories' => [
            ...
            Service\UserCompany::class => Service\UserCompanyFactory::class,
            Service\UserInfo::class => Service\UserInfoFactory::class,
